...
const DAMAGE_RADIUS_PLACEHOLDER: f64 = 10.0;

use crate::{
    backend::{
        shape::{CircleData, PointData, Shape},
        world_objects::{
            components::{
                angular_velocity_properties_component::AngularVelocityPropertiesComponent,
                damaging_entity_component::DamagingEntityCollisionMarker,
            ...
            server_viewport::DisplayableCollisionMarker,
        },
    },
    connectivity::{asset_index::AssetIndex, view_layers::ViewLayers},
    shared_types::{
        AccelerationScalar, AngularVelocity, Coordinates, Distance, Health, Rotation, Speed,
        Velocity,
    },
};
...
use super::{
    components::{
        ...
        rotation_component::RotationComponent, velocity_component::VelocityComponent,
    },
...
pub struct ShipStateBundle {
    ...
    pub damage_collision_marker: CollisionSourceComponent<DamagingEntityCollisionMarker>,
...
impl ShipBundle {
    pub fn new_state_bundle(
        ...
        ShipStateBundle {
            ...
            damage_collision_marker: CollisionSourceComponent::new(Shape::Circle(CircleData {
                location: position,
                radius: Distance::new(DAMAGE_RADIUS_PLACEHOLDER),
            })),
            displayable_collision_marker: CollisionSourceComponent::new(Shape::Point(PointData {
                point: position,
            })),
            health: HealthStateComponent {
                hull: hull,
                shield: shield,
            },
            ...
            semi_newtonian_physics: SemiNewtonianPhysicsStateComponent {
                thrust: acceleration.unwrap_or_default(),
            },
    ...
    pub fn new_data_bundle(asset_index: &AssetIndex) -> Result<ShipDataBundle, ()> {
        ...
        Ok(ShipDataBundle {
            ...
            angular_velocity_properties: AngularVelocityPropertiesComponent {
                maximum_angular_velocity: euclid::Angle {
                    radians: ANGULAR_VELOCITY_PLACEHOLDER,
                },
            },
            health_properties: HealthPropertiesComponent {
                maximum_hull: MAXIMUM_HULL_PLACEHOLDER,
                hull_regeneration_rate: HULL_REGEN_PLACEHOLDER,
                maximum_shield: MAXIMUM_SHIELD_PLACEHOLDER,
                shield_regeneration_rate: SHIELD_REGEN_PLACEHOLDER,
            },
            maximum_acceleration_properties: MaximumAccelerationPropertiesComponent {
                maximum_acceleration: AccelerationScalar::new(MAXIMUM_ACCELERATION_PLACEHOLDER),
            },
            maximum_speed_properties: MaximumSpeedPropertiesComponent {
                maximum_speed: Speed::new(MAXIMUM_SPEED_PLACEHOLDER),
            },
        })
    }
    ...
    pub fn new(
        ...
        let state = Self::new_state_bundle(
            None,
            angular_velocity,
            MAXIMUM_HULL_PLACEHOLDER,
            position,
            rotation,
            MAXIMUM_SHIELD_PLACEHOLDER,
            velocity,
        );
